...
from config import BOARD_SIZE, LR, LR_REDUCE_FACTOR, LR_REDUCE_EPSILON, MOMENTUM, EPOCHS, REG, BATCH_SIZE, VALIDATION_SPLIT, LR_REDUCE_PATIENCE, model_dir, MODEL_SAVE_PERIOD
import os
...
class PZSZModel:
    ...
    def _config_training(self):
        ...
        logger.debug('train from epoch {}...'.format(init_epoch))
